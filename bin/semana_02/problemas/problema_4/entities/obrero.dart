class Obrero {
  ...
  Obrero(this._codigo, this._nombre, this._horasTrabajadas, this._tarifaHora);
  ...
  double obtenerDescAFP() {
    return obtenerSueldoBruto() * 0.10;
  }

  double obtenerDecEPS() {
    return obtenerSueldoBruto() * 0.05;
  }

  double obtenerSueldoNeto() {
    return obtenerSueldoBruto() - obtenerDescAFP() - obtenerDecEPS();
  }
}
